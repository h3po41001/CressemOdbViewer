...
{
	internal class OdbSymbolSquareThermalOpenCorners : OdbSymbolRound, ISymbolSquareThermalOpenCorners
	{
		...
		public static new OdbSymbolSquareThermalOpenCorners Create(int index, string param)
		{
