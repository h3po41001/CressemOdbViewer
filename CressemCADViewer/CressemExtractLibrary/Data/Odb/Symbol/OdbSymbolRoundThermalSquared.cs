...
{
	internal class OdbSymbolRoundThermalSquared : OdbSymbolRound, ISymbolRoundThermalSquared
	{
		...
		public static new OdbSymbolRoundThermalSquared Create(int index, string param)
		{
