...
namespace CressemDataToGraphics.Factory
{
	internal class GdiPlusFactory : GraphicsFactory
	{
		...
		public override IGraphicsShape CreateEllipse(bool useMM, float pixelResolution, bool isMM, double xDatum, double yDatum, double cx, double cy, int orient, bool isMirrorXAxis, double width, double height)
		{
			throw new System.NotImplementedException();
		}

		public override IGraphicsShape CreateRectangle(bool useMM, float pixelResolution, bool isMM, double xDatum, double yDatum, double cx, double cy, int orient, bool isMirrorXAxis, double width, double height)
		{
			throw new System.NotImplementedException();
		}
